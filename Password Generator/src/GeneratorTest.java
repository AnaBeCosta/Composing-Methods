...
class GeneratorTest {
	...
	private final Alphabet firstAlphabet = new Alphabet(new AlphabetConfig(true,false,false,false));
	private final Alphabet secondAlphabet = new Alphabet(new AlphabetConfig(false,true,true,true));
